...
gmms = InterpolGMMs(
    ...
    gmm_kwargs1={
        "l": 3,
        "N": 2000,
        "mus": 5 * torch.tensor([[0.0, 0.0], [5.0, 1.0], [3.0, 4.0]]),
        "lambdas": torch.tensor([2.0, 10.0, 20.0]),
    },
    gmm_kwargs2={
        "l": 4,
        "N": 2000,
        "mus": 5 * torch.tensor([[0.0, 2.0], [1.0, 1.0], [2.0, 2.0], [4.0, 4.0]]),
        "lambdas": torch.tensor([10.0, 2.0, 2.0, 2.0]),
    },
    low_dim_labels=True,
)
